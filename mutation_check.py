...
MUTANTS = [
    ...
    (
        ...
        "        return value",
        "tests/test_m2_calling.py::test_returns_restores_a_nested_named_tuple",
    ),
    (
        ...
        "tests/test_m2_calling.py::test_returns_restores_nested_standard_data_structures",
    ),
    (
        ...
        "tests/test_m2_calling.py::test_returns_and_timeout_compose_in_either_order",
    ),
    (
    ...
    (
        ...
        "        if inspect.isawaitable(result):\n            return result",
        "tests/test_m2_calling.py::test_returns_restores_the_async_result_too",
    ),
    (
        ...
        "tests/test_m2_calling.py::test_returns_names_the_call_and_json_path_when_the_shape_is_wrong",
    ),
    (
